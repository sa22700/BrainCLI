...
def load_brain_data(file_path = os.path.join(os.path.dirname(__file__), "../Models/braindata.fi.pkl")):
    try:
        ...
        print("Virhe ladattaessa braindata.fi.pkl:", e)
        log_error(f"Virhe ladattaessa braindata.fi.pkl: {e}")
...
def update_brain_data(file_path, question, answer):
    ...
    try:
        ...
        print("Virhe tallennettaessa pickle-tiedostoa:", e)
        log_error(f"Virhe tallennettaessa pickle-tiedostoa: {e}")
